    ...
    return (
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-gray-700">Environment Variables</span>
        ...
        <div className="space-y-4">
          ...
          {data.image && (
            <div className="flex items-start gap-3 group">
              ...
              <div className="flex-1 min-w-0">
                <span className="text-xs font-medium text-gray-600 block mb-1">Image</span>
          ...
          {data.command && (
            <div className="flex items-start gap-3 group">
              ...
              <div className="flex-1 min-w-0">
                <span className="text-xs font-medium text-gray-600 block mb-1">Command</span>
                <span className="text-sm text-gray-800 font-mono break-all bg-green-50 px-2 py-1 rounded border border-green-100">
                  {typeof data.command === "string" ? data.command : data.command.join(" ")}
                </span>
              </div>
            </div>
          )}
          ...
          {data.ports && data.ports.length > 0 && (
            <div className="flex items-start gap-3 group">
              ...
              <div className="flex-1 min-w-0">
                <span className="text-xs font-medium text-gray-600 block mb-1">Ports</span>
          ...
          {data.restart && data.restart !== "no" && (
            <div className="flex items-center gap-3 group">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs font-medium text-gray-600">Restart Policy</span>
          ...
          {data.working_dir && (
            <div className="flex items-start gap-3 group">
              ...
              <div className="flex-1 min-w-0">
                <span className="text-xs font-medium text-gray-600 block mb-1">Working Directory</span>
