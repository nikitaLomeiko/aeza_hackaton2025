...
export type ServiceConfigWithCoords = Coords & ServiceConfig;
...
export type NetworkConfigWithCoords = Coords & NetworkConfig
...
export type VolumeConfigWithCoords = Coords & VolumeConfig
...
export type SecretConfigWithCoords = Coords & SecretConfig
...
export type ConfigConfigWithCoords = Coords & ConfigConfig
...
export interface DockerComposeConfigWithCoords {
  ...
  configs?: Record<string, ConfigConfigWithCoords>;
  //   x-*?: any; // Custom extensions
}

// Утилитарные типы
export type ServiceName<T extends DockerComposeConfig> = keyof T["services"];
export type NetworkName<T extends DockerComposeConfig> = keyof NonNullable<T["networks"]>;
export type VolumeName<T extends DockerComposeConfig> = keyof NonNullable<T["volumes"]>;
